...
- (void)viewDidLoad {
    ...
    roundingImage1.image = [UIImage imageNamed:@"testImage"];
    ...
    cornerRadius1.image = [UIImage imageNamed:@"testImage"];
    [cornerRadius1 x_setBorderWidth:5 borderColor:[UIColor orangeColor]];
